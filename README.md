...
Or you can use it to run NVT MD simulations:
...
This script and the input xyz file used here are available in the examples directory. This should work with any input file, simply modify the input_file and cell_size parameters. We recomend using constant volume simulations. 
